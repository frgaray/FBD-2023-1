		...
		\begin{enumerate}
			...
			\item Realizar un ensayo donde expresen sus comentarios (cada integrante del equipo deberá indicar este
				...
				\textbf{Rodrigo}\\	
                      		...
                      		En dicho artículo el autor quiere darnos a conocer la relevancia que 
				tienen los datos y también quiere hacernos ver la magnitud del problema 
				que envuelve el hecho de que estos esten creciendo de manera exponencial 
				a causa de que los costos de almacenamiento esten bajando.

				Quiere informarnos sobre cómo los datos nos pueden brindar muchas ventajas 
				en cuanto a conocimientos o innovaciones en cualquier área de trabajo siempre 
				y cuando sepamos cómo sacarles provecho, ya que los datos por si solos no 
				significan nada si no sabemos cómo analizarlos y manejarlos de manera correcta, 
				ya que el hacer un buen análisis de datos nos lleva  a hacer una transformación 
				y traducción de estos de manera que nos permitan hacer más avances tecnológicos 
				y descubrimientos en ciertas áreas. Esto es un punto clave para poder hacerles 
				las actividades más fáciles al ser humano en su día a día. El autor nos ejemplifica 
				esto tomando algunas áreas como: la economía, la agricultura, la medicina, etc. 
				mostrándonos cómo han resuelto algunas de sus problemáticas a lo largo del tiempo.

				¿Cómo se relaciona con la materia de Fundamentos de Bases de Datos?
				Se relaciona porque el tema principal del artículo es justamente el objeto de 
				estudio de la materia, ya que sobre nosotros cae la responsabilidad del impacto 
				que podrían tener los datos en los ámbitos sociales, económicos, etc, si no sabemos 
				cómo organizarlos, es decir, nosotros tenemos que aprender a analizarlos y a 
				manejarlos para así poder diseñar 	una base de datos eficiente en donde podamos
				guardarlos de manera que estos estén seguros, sea fácil poder acceder a ellos, 
				podamos almacenarlos por mucho tiempo, podamos actualizarlos y la forma en la se 
				guarden este organizada y optimizada, y así poder brindarle a las personas una buena 
				herramienta con la que puedan trabajar y que esta sea fácil de usar.\\
				
				A través de todo el artículo el autor se empeña en exhibir los datos como una 
				herramienta sumamente útil para la sociedad, por esta razón podemos decir que 
				el tema central de toda la exposición es la utilidad de los datos. Para convencernos 
				de esto el autor recurre a un recuento histórico de cómo almacenar datos y 
				posteriormente estudiarlos ha ayudado a tener conocimiento de las rutas marítimas,
				registrar enfermedades, su posible tratamiento, etc. Este recorrido que 
				puede ser considerado como un tema lateral no sólo es usado para mostrar la presencia 
				de los datos en distintas épocas de la humanidad y su contribución a hacer las 
				labores más sencillas mediante la generación de conocimiento, sino que también 
				para contrastar lo rudimentario que era el manejo de estos y cómo fue que el 
				desarrollo tecnológico ha permitido que los datos sean recolectados, clasificados,
				analizados y transformados en información que se pretende convertir en conocimiento. 
				Todo esto de una manera mucho más simple de lo que se había visto en décadas pasadas.\
