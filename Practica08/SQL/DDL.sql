...
ALTER TABLE EmpleadoTelefono ADD FOREIGN KEY (IdEmpleado) REFERENCES Empleado(IdEmpleado) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE VentaElectronica ADD FOREIGN KEY (IdCliente) REFERENCES Cliente(IdCliente) ON UPDATE CASCADE ON DELETE SET NULL;
ALTER TABLE VentaFisica ADD FOREIGN KEY (IdCliente) REFERENCES Cliente(IdCliente) ON UPDATE CASCADE ON DELETE SET NULL;
ALTER TABLE VentaFisica ADD FOREIGN KEY (AyudarIdEmpleado) REFERENCES Empleado(IdEmpleado) ON UPDATE CASCADE ON DELETE SET NULL;
ALTER TABLE VentaFisica ADD FOREIGN KEY (CobrarIdEmpleado) REFERENCES Empleado(IdEmpleado) ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE EntregarVentaElectronica ADD FOREIGN KEY (IdVentaElectronica)
REFERENCES VentaElectronica(IdVentaElectronica) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE EntregarVentaElectronica ADD FOREIGN KEY (NombrePlanta)
REFERENCES Planta(NombrePlanta) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE EntregarVentaFisica ADD FOREIGN KEY (IdVentaFisica)
REFERENCES VentaFisica(IdVentaFisica) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE EntregarVentaFisica ADD FOREIGN KEY (NombrePlanta)
REFERENCES Planta(NombrePlanta) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE EstarEn ADD FOREIGN KEY (NombreVivero) REFERENCES Vivero(NombreVivero) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE EstarEn ADD FOREIGN KEY (NombrePlanta) REFERENCES Planta(NombrePlanta) ON UPDATE CASCADE ON DELETE CASCADE;

--Las que faltaban
ALTER TABLE ViveroTelefono ADD FOREIGN KEY (NombreVivero) REFERENCES Vivero(NombreVivero) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ClienteTelefono ADD FOREIGN KEY (IdCliente) REFERENCES Cliente(IdCliente) ON UPDATE CASCADE ON DELETE CASCADE;;
ALTER TABLE ClienteCorreoElectronico ADD FOREIGN KEY (IdCliente) REFERENCES Cliente(IdCliente) ON UPDATE CASCADE ON DELETE CASCADE;;
ALTER TABLE EmpleadoCorreoElectronico ADD FOREIGN KEY (IdEmpleado) REFERENCES Empleado(IdEmpleado) ON UPDATE CASCADE ON DELETE CASCADE;;
